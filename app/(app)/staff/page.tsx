          ...
          <Card key={member.name} className="space-y-3">
            <div className="flex flex-col justify-between gap-3 sm:flex-row sm:items-center">
              <div className="min-w-0">
                ...
                <p className="break-words text-sm text-[var(--muted-foreground)]">{member.role}</p>
              </div>
              <Badge className="w-fit" tone={member.commission > 0 ? "success" : "default"}>{member.commission}% commission</Badge>
            </div>
